...
main_folder_path = r'C:\Users\kamalesh.kb\PAVE_SEPT'

# Assuming 'df' is your dataframe with SOC data
def process_log_file(log_file, folder_path):
    ...
    while i < len(df) and t2_index > 0:
        ...
        if i == len(df) - 1 or i == last_valid_index or t1 == last_Valid_time or t2 == last_Valid_time: 
            print('Final Battery changed at:', t1)
            break
    ...
    if os.path.isdir(subfolder_1_path):
        ...
        for subfolder in os.listdir(subfolder_1_path):
            ...
            if os.path.isdir(subfolder_path):
                ...
                if log_found:
                    try:
                        process_log_file(log_file, subfolder_path)

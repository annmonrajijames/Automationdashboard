...
def choose_folder():
    ...
    if source_folder:
        ...
        if app_data['selected_option'] == "Daily_Analysis":
            destination_folder = r"C:\Lectrix_company\work\Git_Projects\Automationdashboard\master\main\menu_1_Daily_Analysis"
        elif app_data['selected_option'] == "Battery based - ANALYSIS":
            destination_folder = r"C:\Lectrix_company\work\Git_Projects\Automationdashboard\master\main\menu_2_Battery_Analysis"
        elif app_data['selected_option'] == "Error Reasoning":
            destination_folder = r"C:\Lectrix_company\work\Git_Projects\Automationdashboard\master\main\menu_3_Error_Causes"
        else:
...
def cleanup_directories():
    ...
    directories = [
        r"C:\Lectrix_company\work\Git_Projects\Automationdashboard\master\main\menu_1_Daily_Analysis",
        r"C:\Lectrix_company\work\Git_Projects\Automationdashboard\master\main\menu_2_Battery_Analysis",
        r"C:\Lectrix_company\work\Git_Projects\Automationdashboard\master\main\menu_3_Error_Causes",

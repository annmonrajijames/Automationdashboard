    ...
    for subfolder in os.listdir(main_folder_path):
        ...
        while i >= 0 and t2_index >0:
            ...
            if abs(df.iloc[i]['SOC_8'] - df.iloc[t2_index]['SOC_8']) > threshold:
                ...
                os.makedirs(os.path.join(main_folder_path, folder_name), exist_ok=True)
        
                # Save the battery data to a new CSV file inside the folder
                battery_data.to_csv(os.path.join(main_folder_path, folder_name, f'log_file.csv'), index=False)
...
main_folder_path = r"C:\Users\kamalesh.kb\CodeForAutomation\Automationdashboard\Automationdashboard\MAIN_FOLDER\Automation_Dashboard_Batterywise\BatteryAnalysis"
